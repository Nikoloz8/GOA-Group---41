...
formated_string = template.format(name="alice", place="Wonderland") # {} - ეს არის ეგრეთწოდებული სლოტი, რომელშიც შეიძლება ჩავსვათ სხადასხვა ელემენტი. format ფუნქცია გამოიყენება string-ების გასაუმჯობესებლად, რაც გამოიხატება "სლოტებში" ჩასმით.
